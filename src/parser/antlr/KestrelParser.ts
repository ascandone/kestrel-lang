...
export default class KestrelParser extends Parser {
	...
	public static readonly TYPE_ID = 39;
	...
	public expr(_p?: number): ExprContext {
		...
		try {
			...
			case 6:
				...
				_prevctx = localctx;
				this.state = 41;
				(localctx as BoolNotContext)._op = this.match(KestrelParser.T__3);
				this.state = 42;
				this.expr(16);
				}
				break;
			...
			case 12:
				...
				this._errHandler.sync(this);
				_la = this._input.LA(1);
				if ((((_la) & ~0x1F) === 0 && ((1 << _la) & 1493172240) !== 0) || ((((_la - 33)) & ~0x1F) === 0 && ((1 << (_la - 33)) & 1953) !== 0)) {
					{
					this.state = 83;
					this.expr(0);
					this.state = 88;
			...
			while (_alt !== 2 && _alt !== ATN.INVALID_ALT_NUMBER) {
				if (_alt === 1) {
					...
					case 3:
						...
						this.state = 106;
						(localctx as ConsContext)._op = this.match(KestrelParser.T__14);
						this.state = 107;
						this.expr(13);
						}
						break;
					...
					case 6:
						...
						this.state = 115;
						(localctx as BoolOrContext)._op = this.match(KestrelParser.T__21);
						this.state = 116;
						this.expr(11);
						}
						break;
					case 7:
						...
						this.state = 118;
						(localctx as BoolAndContext)._op = this.match(KestrelParser.T__22);
						this.state = 119;
						this.expr(10);
						}
						break;
	...
	public static readonly _serializedATN: number[] = [4,1,45,167,2,0,7,0,2,
	...
	4,1,4,1,4,1,4,1,4,1,4,1,4,1,4,1,4,1,4,1,4,1,4,1,4,1,4,5,4,50,8,4,10,4,12,
	4,53,9,4,1,4,1,4,1,4,1,4,1,4,1,4,1,4,1,4,1,4,1,4,1,4,5,4,66,8,4,10,4,12,
	4,69,9,4,1,4,3,4,72,8,4,3,4,74,8,4,1,4,1,4,1,4,1,4,1,4,1,4,1,4,1,4,1,4,
	1,4,1,4,5,4,87,8,4,10,4,12,4,90,9,4,1,4,3,4,93,8,4,3,4,95,8,4,1,4,3,4,98,
	8,4,1,4,1,4,1,4,1,4,1,4,1,4,1,4,1,4,1,4,1,4,1,4,1,4,1,4,1,4,1,4,1,4,1,4,
	1,4,1,4,1,4,1,4,1,4,1,4,1,4,1,4,1,4,1,4,1,4,1,4,5,4,129,8,4,10,4,12,4,132,
	9,4,1,4,3,4,135,8,4,3,4,137,8,4,1,4,5,4,140,8,4,10,4,12,4,143,9,4,1,5,1,
	5,1,5,1,5,1,6,1,6,1,6,1,6,1,6,1,6,1,6,1,6,1,6,1,6,1,6,1,6,1,6,1,6,1,6,1,
	6,3,6,165,8,6,1,6,0,1,8,7,0,2,4,6,8,10,12,0,4,1,0,5,9,1,0,10,14,1,0,16,
	17,1,0,18,21,193,0,17,1,0,0,0,2,22,1,0,0,0,4,31,1,0,0,0,6,33,1,0,0,0,8,
	97,1,0,0,0,10,144,1,0,0,0,12,164,1,0,0,0,14,16,3,2,1,0,15,14,1,0,0,0,16,
	19,1,0,0,0,17,15,1,0,0,0,17,18,1,0,0,0,18,20,1,0,0,0,19,17,1,0,0,0,20,21,
	5,0,0,1,21,1,1,0,0,0,22,23,5,1,0,0,23,26,5,38,0,0,24,25,5,2,0,0,25,27,3,
	4,2,0,26,24,1,0,0,0,26,27,1,0,0,0,27,28,1,0,0,0,28,29,5,3,0,0,29,30,3,8,
	4,0,30,3,1,0,0,0,31,32,3,6,3,0,32,5,1,0,0,0,33,34,5,39,0,0,34,7,1,0,0,0,
	35,36,6,4,-1,0,36,98,5,40,0,0,37,98,5,43,0,0,38,98,5,41,0,0,39,98,5,42,
	0,0,40,98,5,38,0,0,41,42,5,4,0,0,42,98,3,8,4,16,43,44,5,24,0,0,44,45,3,
	8,4,0,45,46,5,25,0,0,46,51,3,8,4,0,47,48,5,25,0,0,48,50,3,8,4,0,49,47,1,
	0,0,0,50,53,1,0,0,0,51,49,1,0,0,0,51,52,1,0,0,0,52,54,1,0,0,0,53,51,1,0,
	0,0,54,55,5,26,0,0,55,98,1,0,0,0,56,57,5,24,0,0,57,58,3,8,4,0,58,59,5,26,
	0,0,59,98,1,0,0,0,60,98,3,10,5,0,61,73,5,27,0,0,62,67,5,38,0,0,63,64,5,
	25,0,0,64,66,5,38,0,0,65,63,1,0,0,0,66,69,1,0,0,0,67,65,1,0,0,0,67,68,1